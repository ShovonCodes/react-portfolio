...
const Resume = () => {
	return (
		<div className="page" id="resume">
			...
			>
				• Created scalable restful APIs that powers the smooth workflow
				in the frontend.
				<br />• Designed and built the payment page frontend, a payment
			...
			>
				...
				an MCQ based examination system.
				<br />• Collaborated with team and maintained the workflow and
				deadline using Scrum.
			</ResumeItem>
